document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function addTodo() {
        ...
        try {
            ...
            const todo = response.data.todo || response.data; // backward compat
            renderTodo(todo);
            todoInput.value = "";
        } catch (e) {
    ...
    async function updateTodo(id, completed) {
        try {
            ...
            if (li) {
                li.style.textDecoration = updated.completed ? "line-through" : "none";
                li.querySelector('button').textContent = updated.completed ? 'Undo' : 'Complete';
            }
        } catch (e) {
